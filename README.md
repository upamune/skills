...
- [init-project](./skills/engineering/init-project/SKILL.md): Go / TypeScript (Bun + Effect) の新規プロジェクトを mise・CI（format/lint/typecheck/test, pinact）・backlog・upamune/skills 込みで立ち上げる。新しいリポジトリで最初に一度だけ実行する。
